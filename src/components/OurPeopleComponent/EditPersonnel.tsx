                        ...
                        <div className='w-full grid grid-cols-2 gap-6 mt-8' >
                            <div className='w-full font-Inter-Regular' >
                                ...
                                <Input 
                                    ...
                                    fontSize='sm' border='1px solid #DDE2E5' backgroundColor='white' placeholder={userContext.userData.name} />
                            ...
                            <div className='w-full font-Inter-Regular' >
                                ...
                                <Input 
                                    ...
                                    fontSize='sm' border='1px solid #DDE2E5' backgroundColor='white' placeholder={userContext.userData.personalEmail} />
                                <div className="w-full h-auto pt-2">
                            ...
                            <div className='w-full font-Inter-Regular' >
                                ...
                                <Select 
                                    ...
                                    fontSize='sm' border='1px solid #DDE2E5' backgroundColor='white' placeholder={userContext.userData.department} >
                            ...
                            <div className='w-full font-Inter-Regular' >
                                ...
                                <Input 
                                    ...
                                    fontSize='sm' border='1px solid #DDE2E5' backgroundColor='white' placeholder={userContext.userData.companyEmail} />
                                <div className="w-full h-auto pt-2">
                            ...
                            <div className='w-full font-Inter-Regular' >
                                ...
                                <Input 
                                    ...
                                    fontSize='sm' border='1px solid #DDE2E5' backgroundColor='white' placeholder={userContext.userData.personalPhone} />
                                <div className="w-full h-auto pt-2">
                            ...
                            {/* <div className='w-full font-Inter-Regular' >
                                ...
                                <Input 
                                    ...
                                    fontSize='sm' border='1px solid #DDE2E5' backgroundColor='white' placeholder={userContext.userData.address} />
                                <div className="w-full h-auto pt-2">
                            ...
                            <div className='w-full font-Inter-Regular' >
                                ...
                                <Input 
                                    ...
                                    fontSize='sm' border='1px solid #DDE2E5' backgroundColor='white' placeholder={userContext.userData.companyPhone} />
                                <div className="w-full h-auto pt-2">
                    ...
                    :
                        <>
                            <div className='w-auto' >
                                <p className='font-Inter-SemiBold text-xl mt-4 ' >{userContext.userData.name}</p>
                                <p className='font-Inter-Regular text-[#ACB5BD] text-sm' >{userContext.userData.department}</p>
                            </div>
                            <div className='mt-6' >
                                <div className='flex items-center my-2' >
                                    ...
                                    <p className=' font-Inter-Regular text-sm' >{userContext.userData.personalEmail}</p>
                                </div>
                                <div className='flex items-center my-2' >
                                    <svg className='mr-3'  width="18" height="16" viewBox="0 0 18 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path fill-rule="evenodd" clip-rule="evenodd" d="M0.00976562 1.83789C0.00976562 1.28561 0.457481 0.837891 1.00977 0.837891H17C17.5523 0.837891 18 1.28561 18 1.83789V13.1621C18 14.2667 17.1046 15.1621 16 15.1621H2C0.89543 15.1621 0 14.2667 0 13.1621V2.16211C0 2.11449 0.00332856 2.06765 0.00976562 2.0218V1.83789ZM2 4.06165V13.1621H16V4.06199L11.1215 8.9405C9.94992 10.1121 8.05042 10.1121 6.87885 8.9405L2 4.06165ZM3.57232 2.80554H14.428L9.70728 7.52628C9.31675 7.91681 8.68359 7.91681 8.29306 7.52628L3.57232 2.80554Z" fill="#ACB5BD"/>
                                    </svg>
                                    <p className=' font-Inter-Regular text-sm' >{userContext.userData.companyEmail}</p>
                                </div> 
                                <div className='flex items-center my-2' >
                                    ...
                                    <p className=' font-Inter-Regular text-sm' >{userContext.userData.personalPhone}</p>
                                </div> 
                                <div className='flex items-center my-2' >
                                    <svg className='mr-3' width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M20 10C20 8.68677 19.7413 7.38647 19.2388 6.1731C18.7362 4.95996 17.9997 3.85742 17.0711 2.92896C16.1425 2.00024 15.0401 1.26367 13.8268 0.76123C12.6136 0.258545 11.3132 0 10 0V2C11.0506 2 12.0909 2.20703 13.0615 2.60889C14.0321 3.01099 14.914 3.60034 15.6569 4.34326C16.3997 5.08594 16.989 5.96802 17.391 6.93848C17.7931 7.90918 18 8.94946 18 10H20Z" fill="#ACB5BD"/>
                                    ...
                                    <p className=' font-Inter-Regular text-sm' >{userContext.userData.companyPhone}</p>
                                </div> 
                                <div className='flex items-center my-2' >

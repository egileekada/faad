    ...
    return (
        <div className='w-full' >
            <div className='w-full flex items-center font-Inter-Regular' > 
                ...
                <button onClick={()=> navigate('editprofile')} className=' rounded w-44 flex justify-center items-center h-10 font-Inter-SemiBold ml-auto text-sm text-white bg-[#F88C3A]' >
            ...
            <div className='w-full grid grid-cols-4 gap-6 mt-10' >
                <div style={{boxShadow: '0px 16px 24px 0px #60617029'}} className=' bg-white rounded-2xl' >
                    <div style={{boxShadow: '0px 2px 8px 0px #60617029'}} className='w-full py-5 rounded-2xl flex flex-col items-center' >
                        <div className='w-16 h-16 rounded-full bg-red-300' ></div>
                        <p className='font-Inter-SemiBold text-lg mt-4' >Kimora Kim</p>
                        <p className='font-Inter-Regular text-sm' >Customer care</p>
                        <p className='font-Inter-Regular text-xs'>kim.kim@faadoil.com</p>
                        ...
                        <p className='font-Inter-Regular text-xs'>Joined 2020</p>
                    </div>
                </div>
                <div style={{boxShadow: '0px 16px 24px 0px #60617029'}} className='bg-white rounded-2xl' >
                    <div style={{boxShadow: '0px 2px 8px 0px #60617029'}} className='w-full py-5 rounded-2xl flex flex-col items-center' >

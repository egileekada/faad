            ...
            <div className=' w-full flex border-b border-[#E0E0E0] pb-10' >
                <div className='flex flex-col flex-1 pr-10 ' > 
                    <div className='w-full flex' > 
                        ...
                        <p className='font-Inter-Regular mt-4 text-sm ml-auto ' >12 - 01 - 2020</p>
                    </div>
                    ...
                    <p className='font-Inter-Regular mt-4 text-sm mb-2' >jesica@schlumbeger.com</p>
                    <p className='font-Inter-Regular text-sm my-2' >+2348133223322</p>
                    <p className='font-Inter-Bold text-sm my-2' >Product: <span className='font-Inter-Regular mr-3' >AGO</span> Quantity: <span className='font-Inter-Regular'>12000 ℓ</span></p>
                    <p className='font-Inter-Bold text-sm my-2' >Asking price: <span className='font-Inter-Regular mr-3' >N123.42</span> Bidding price: <span className='font-Inter-Regular'>N123.42 </span></p>

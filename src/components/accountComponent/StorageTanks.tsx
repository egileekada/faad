            ...
            <div className='w-full grid grid-cols-2 gap-x-4 pb-12 border-[#E0E0E0] border-b  gap-y-14 px-10 mt-8' >
                <div className='w-full flex items-center' >
                    ...
                    <div className='ml-3' >
                        ...
                        <p className='font-Inter-Bold mb-2 text-sm' >Product<span className='font-Inter-Regular ml-3' >Diesel (AGO)</span></p>
                        <p className='font-Inter-Bold mt-1 mb-2 text-sm' >Capacity<span className='font-Inter-Regular ml-3' >3,000,000.00 ℓ</span></p>
                        <p className='font-Inter-Bold my-1 mb-2 text-sm' >Dirt<span className='font-Inter-Regular ml-3' >2,000.00 ℓ</span></p>
                        <p className='font-Inter-Bold my-1 mb-2 text-sm' >Tank ID<span className='font-Inter-Regular ml-3' >FD442</span></p>
                        <p className='font-Inter-Bold my-1 mb-2 text-sm' >Location<span className='font-Inter-Regular ml-3' >GRA 1</span></p>
                        <p className='font-Inter-Bold my-1 mb-2 text-sm text-[#00BE00] ' >Level<span className='font-Inter-Regular ml-3' >2,800,000.20 ℓ</span></p>
                        <p className='font-Inter-Bold my-1 mb-2 text-sm' >Avg Price<span className='font-Inter-Regular ml-3' >450/ℓ</span></p> 

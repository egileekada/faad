        ...
        <div style={{border: '1px solid #DDE2E5'}} className='bg-white rounded-lg p-8 ' >
            <div  className='w-full h-full flex flex-col' >
                ...
                <div className='flex mt-4 items-center' >  
                    ...
                    <div className='w-96' >
                        <Input type="number" value={props.dispatch} onChange={(e)=> OnChangeHandler(e.target.value)} placeholder='00.00' fontSize='sm' />
                    </div> 
                </div>
                ...
                {/* <div className='flex mt-4 items-center ml-28 cursor-pointer' >
                    <svg onClick={()=> props.tank([...props.tankId, 'New'])} className='mr-3' width="20" height="21" viewBox="0 0 20 21" fill="none" xmlns="http://www.w3.org/2000/svg">

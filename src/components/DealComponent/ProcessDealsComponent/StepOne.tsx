        ...
        <div style={{border: '1px solid #DDE2E5'}} className='bg-white rounded-lg p-8 ' >
            <div  className='w-full h-full flex flex-col' >
                ...
                <div className='flex mt-4 items-center' >  
                        ...
                        <div className='w-72' >
                            <Select placeholder='AGO' fontSize='sm' />
                        </div>
                        <div className='ml-6' > 
                            <p className='font-Inter-Bold text-[#000] text-sm ' >Client:</p>
                            <p className='font-Inter-Regular mt-1 text-[#ACB5BD] text-sm ' >Schlumberger LTD</p>
                        </div>
                </div>
                <div className='flex mt-4 items-center' >  
                        <p className='font-Inter-Regulartext-[#ACB5BD] text-sm w-28 ' >Quantity requested (ℓ)</p> 
                        <div className='w-72' >
                            <Input placeholder='AGO' fontSize='sm' />
                        </div>
                        <div className='ml-6' > 
                            <p className='font-Inter-Bold text-[#000] text-sm ' >Supply location:</p>
                            <p className=' w-64 font-Inter-Regular mt-1 text-[#ACB5BD] text-sm ' >Schlumberger LTD 16, Alaska street, East west road, Before the bridge, Port Harcourt. RIvers State </p>
                        </div>
                </div>
                <div className='flex mt-4 items-center' >  
                        <p className='font-Inter-Regulartext-[#ACB5BD] text-sm w-28 ' >Dispatch tank</p> 
                        <div className='w-72' >
                ...
                <div className='flex mt-4 items-center' >  
                        <p className='font-Inter-Regulartext-[#ACB5BD] text-sm w-28 ' >Choose a truck</p> 
                        <div className='w-72' >
                            <Select placeholder='Search' fontSize='sm' />
                        </div> 
                </div>
                <div className='flex mt-4 items-center ml-28' >

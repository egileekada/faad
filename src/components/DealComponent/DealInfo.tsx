                ...
                <div className=' w-full flex ' >
                    <div className='flex w-full flex-col flex-1  ' > 
                        <div className='w-full flex items-center px-10' > 
                            <p className='font-Inter-SemiBold text-2xl ' >Schlumberger LTD</p>
                            <div className='ml-auto' >
                                <p className='font-Inter-Regular text-sm ' >12 - 01 - 2020 • 5:30</p>
                                <p className='font-Inter-Regular text-sm ' >Created by Kimora</p>
                                <p className='font-Inter-Bold text-sm ' >FA2343-B3</p>
                            </div> 
                        </div>
                        <p className='font-Inter-Regular mt-4 text-sm px-10 ' >16, Alaska street, East west road, Before the bridge, Port Harcourt. Rivers State</p>
                        <p className='font-Inter-Regular mt-2 text-sm px-10 ' >jesica@schlumbeger.com</p>
                        <p className='font-Inter-Regular mt-2 text-sm my-2 px-10 ' >+2348133223322</p>
                        ...
                        <div className='w-full grid-cols-3 grid gap-4 my-2 px-10 ' >
                            <p className='font-Inter-Bold text-sm' >Product: <span className='font-Inter-Regular mr-3' >AGO</span></p>
                            <p className='font-Inter-Bold text-sm'>Quantity: <span className='font-Inter-Regular mr-3'>12000 ℓ</span></p>
                            <p className='font-Inter-Bold text-sm'>DD. Quantity: <span className='font-Inter-Regular'>12000 ℓ</span></p>
                        </div>
                        <div className='w-full grid-cols-3 grid gap-4 my-2  px-10 ' >
                            <p className='font-Inter-Bold text-sm' >Asking price: <span className='font-Inter-Regular mr-3' >N123.42</span></p>
                            <p className='font-Inter-Bold text-sm'>Bidding price:: <span className='font-Inter-Regular mr-3'>N123.42</span></p> 
                        </div>
